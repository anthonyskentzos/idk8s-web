...
async function fetchEnvironment() {
    try {
        ...
        document.getElementById('environment').textContent = data.configMapEnv || 'Unknown';
        document.getElementById('environment').classList.remove('loading');
    } catch (error) {
        console.error('Error fetching environment data:', error);
        document.getElementById('environment').textContent = 'Error fetching environment';
        document.getElementById('environment').classList.remove('loading');
        document.getElementById('environment').classList.add('error');
    }
}
